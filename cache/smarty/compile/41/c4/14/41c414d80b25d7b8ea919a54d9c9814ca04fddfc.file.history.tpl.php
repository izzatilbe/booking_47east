<?php /* Smarty version Smarty-3.1.19, created on 2020-01-28 07:23:36
         compiled from "/home/tilbae/Projects/hotelcommerce/themes/hotel-reservation-theme/history.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13361785055e2fe178d6eb43-66358199%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '41c414d80b25d7b8ea919a54d9c9814ca04fddfc' => 
    array (
      0 => '/home/tilbae/Projects/hotelcommerce/themes/hotel-reservation-theme/history.tpl',
      1 => 1580196143,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13361785055e2fe178d6eb43-66358199',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e2fe178f14395_23877214',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e2fe178f14395_23877214')) {function content_5e2fe178f14395_23877214($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/home/tilbae/Projects/hotelcommerce/tools/smarty/plugins/modifier.regex_replace.php';
?>
...
<?php $_tmp40=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['order_refund_info']->value[$_tmp40]['waitting'];?>
 ...
 : <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['order']->value['id_order'];?>
<?php $_tmp41=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['order_refund_info']->value[$_tmp41]['accepted'];?>
 ...
 : <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['order']->value['id_order'];?>
<?php $_tmp42=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['order_refund_info']->value[$_tmp42]['rejected'];?>
 ...
 : <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['order']->value['id_order'];?>
<?php $_tmp43=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['order_refund_info']->value[$_tmp43]['refunded'];?>
...
<?php $_tmp44=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-opc',true,null,"submitReorder&id_order=".$_tmp44), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php } else { ?>
								<a class="link-button" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['order']->value['id_order']);?>
<?php $_tmp45=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"submitReorder&id_order=".$_tmp45), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php }?>
