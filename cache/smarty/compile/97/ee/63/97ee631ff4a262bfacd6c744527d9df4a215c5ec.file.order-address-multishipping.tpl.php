<?php /* Smarty version Smarty-3.1.19, created on 2020-01-28 07:23:35
         compiled from "/home/tilbae/Projects/hotelcommerce/themes/hotel-reservation-theme/order-address-multishipping.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10486594945e2fe1774202d0-57434296%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '97ee631ff4a262bfacd6c744527d9df4a215c5ec' => 
    array (
      0 => '/home/tilbae/Projects/hotelcommerce/themes/hotel-reservation-theme/order-address-multishipping.tpl',
      1 => 1580196143,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10486594945e2fe1774202d0-57434296',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e2fe17750d233_40690137',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e2fe17750d233_40690137')) {function content_5e2fe17750d233_40690137($_smarty_tpl) {?>
...
<?php $_tmp10=ob_get_clean();?><?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['back']->value) {?><?php echo "&mod=";?><?php echo (string)$_smarty_tpl->tpl_vars['back']->value;?><?php }?><?php $_tmp11=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1".$_tmp10.$_tmp11), ENT_QUOTES, 'UTF-8', true);?>
...
<i class="icon-chevron-right right"></i></span></a>
	...
	<p class="address_add submit">
		<a href="<?php ob_start();?><?php echo urlencode('&multi-shipping=1');?>
<?php $_tmp12=ob_get_clean();?><?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['back']->value) {?><?php echo "&mod=";?><?php echo urlencode($_smarty_tpl->tpl_vars['back']->value);?>
<?php }?><?php $_tmp13=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1".$_tmp12.$_tmp13), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Add'),$_smarty_tpl);?>
" class="button button-small btn btn-default"><span><?php echo smartyTranslate(array('s'=>'Add a new address'),$_smarty_tpl);?>
<i class="icon-chevron-right right"></i></span></a>
	</p>
